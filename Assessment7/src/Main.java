...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		xlRead("C://Users/vtrivedi4//Documents//assess7.xls");
		...
		System.setProperty("webdriver.chrome.driver","C:\\Selenium\\chromedriver.exe");
		 ...
		 myD.findElement(By.xpath("/html/body/div[2]/div/div/div/div/div/div/div[2]/div/div/form/table/tbody/tr/td[1]/input[1]")).sendKeys(vsearch);
		 myD.findElement(By.xpath("/html/body/div[2]/div/div/div/div/div/div/div[2]/div/div/form/table/tbody/tr/td[2]/button/i")).click();
	     Thread.sleep(5000);
	     xData[i][2]=myD.getTitle();
	     myD.close();
		}	
		xlwrite("C:/Users/vtrivedi4/Documents/assess7.xls",xData);
